...
urlpatterns = [
    ...
    path('patient/invoice/<int:pk>/', views.patient_invoice_view, name='patient_invoice_view'),
    path('patient/invoice/<int:pk>/download/', views.download_invoice_pdf, name='download_invoice_pdf'),
...
path('Extras/voice-call/', views.patient_voice_call, name='patient_voice_call'),
path('Extras/video-call/', views.patient_voice_call, name='patient_video_call'),
path('Extras/search-doctors/', views.patient_search_doctors, name='patient_search_doctors'),
    path('Extras/calendar/', views.patient_calendar, name='patient_calendar'),
    path('Extras/components/', views.patient_components, name='patient_components'),
    path('Extras/invoices/', views.patient_invoices, name='patient_invoices'),
    path('Extras/invoice-view/', views.patient_invoice_view, name='patient_invoice_view'),
path('Extras/invoice-report/', views.patient_invoice_report, name='patient_invoice_report'),
